            ...
            <div className='container-fluid'>
                ...
                <div className="row ml-client-form-row">
                    ...
                    <div className="col-12 col-md-6 p-5 alig-itmes-center">
                        ...
                        <p className='text-justify'>Silahkan bergabung dengan group whatsapp Webinar di link berikut dan jangan lupa melakukan konfirmasi pembayaran ke nomor <b>+67899856890987</b> </p>
